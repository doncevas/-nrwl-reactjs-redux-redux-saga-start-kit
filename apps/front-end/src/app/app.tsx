...
import {makeSelectUsername, changeUsername } from '@nrwl-saga-redux-starter/data'
...
export const App = () => {
  const {username} = useSelector(stateSelector);
   const dispatch = useDispatch();

   useEffect(() => {
    dispatch(changeUsername('set new name'));
   },[]);
